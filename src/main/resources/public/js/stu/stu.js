layui.use(['table', 'layer'], function () {
    ...
    function deleteUsers(userData) {
        ...
        // 询问用户是否确认删除
        layer.confirm('您确定要删除选中的记录吗？', {icon: 3, title: '成员管理'}, function (index) {
            // 关闭确认框
            layer.close(index);
    ...
    function deleteUser(id) {
        // 弹出确认框，询问用户是否确认删除
        layer.confirm('确定要删除该记录吗？', {icon: 3, title: "成员管理"}, function (index) {
            // 关闭确认框
            layer.close(index);
